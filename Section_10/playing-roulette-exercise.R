...
roulette = function(){
  winnings = sample(c(5, -5), size=20, replace=TRUE, prob=c(18/38, 20/38))
  sum(winnings)
}
...
table(s)
plot(table(s), main="Frequency of Positive Cumulative Winnings", xlab="Number of Plays with Positive Winnings", ylab="Frequency")
